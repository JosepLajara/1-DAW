...
<body>
  ...
  <h1>En esta web se mostraran los países ordenados por el año en el que se independizaron</h1>
  <?php
  ...
  if ($base_datos->connect_errno){
    ...
    $resultado=$base_datos->query('SELECT Name,IndepYear FROM country ORDER BY IndepYear DESC');
