<div class="" hidden>
  ...
  if (isset($_POST["enviar"])){
    $consulta->crear_user($_POST['ID'],$_POST['NombreUsuario'],$_POST['ApellidosUsuario'],$_POST['EdadUsuario'],$_POST['CursoUsuario'],$_POST['PuntuacionUsuario']);
  }
  ?>
      ...
      <form class="header" action="" method="post"> <!-- formulario que actualiza a un usuario -->
        ...
        <div id="registro">
          <table>
            ...
            <tr>
              <td><b>Edad</b></td>
              <td><input type="text" name="EdadUsuario" placeholder="Año de nacimiento"/></td>
            </tr>
            <tr>
              <td><b>Curso</b></td>
